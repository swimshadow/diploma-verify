...
const demoAccounts = [
  DemoAccount(
    ...
    icon: Icons.school,
    color: Colors.teal,
    description: 'Дипломы, переписки с работодателями, верифицированные сертификаты',
  ),
  DemoAccount(
    label: 'Работодатель',
    ...
    icon: Icons.business,
    color: Colors.indigo,
    description: 'История проверок, 3 метода верификации дипломов',
  ),
  DemoAccount(
    label: 'Университет',
    email: 'university@demo.ru',
    password: 'Demo123',
    role: 'university',
  ...
  DemoAccount(
    ...
    color: Colors.brown,
    description: 'Панель управления, модерация, мониторинг, аудит',
  ),
];
